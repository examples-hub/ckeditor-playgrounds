...
import PlaceholderCommand from './placeholder-cmd';
...
export default class PlaceholderEditing extends Plugin {
  ...
  init() {
    ...
    // Every position inside the view <span> element will be mapped to a position outside the <placeholder> in the model.
